...
type PubMResolver interface {
	...
	Signup(ctx context.Context, username string, password string, email string, firstName *string, lastName *string) (*Error, error)
}
...
func field_PubM_signup_args(rawArgs map[string]interface{}) (map[string]interface{}, error) {
	args := map[string]interface{}{}
	var arg0 string
	if tmp, ok := rawArgs["username"]; ok {
		var err error
...
func field_PubQ___type_args(rawArgs map[string]interface{}) (map[string]interface{}, error) {
	args := map[string]interface{}{}
	var arg0 string
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "PubM.login":
		...
		args, err := field_PubM_login_args(rawArgs)
		if err != nil {
			return 0, false
		}

		return e.complexity.PubM.Login(childComplexity, args["username"].(string), args["password"].(string)), true

	case "PubM.signup":
		if e.complexity.PubM.Signup == nil {
			break
		}

		args, err := field_PubM_signup_args(rawArgs)
		if err != nil {
			return 0, false
		}
...
func (e *executableSchema) Query(ctx context.Context, op *ast.OperationDefinition) *graphql.Response {
	...
	buf := ec.RequestMiddleware(ctx, func(ctx context.Context) []byte {
		data := ec._PubQ(ctx, op.SelectionSet)
...
func (e *executableSchema) Mutation(ctx context.Context, op *ast.OperationDefinition) *graphql.Response {
	...
	buf := ec.RequestMiddleware(ctx, func(ctx context.Context) []byte {
		data := ec._PubM(ctx, op.SelectionSet)
		var buf bytes.Buffer
		data.MarshalGQL(&buf)
		return buf.Bytes()
	})
...
// nolint: gocyclo, errcheck, gas, goconst
func (ec *executionContext) _PubM(ctx context.Context, sel ast.SelectionSet) graphql.Marshaler {
	fields := graphql.CollectFields(ctx, sel, pubMImplementors)
	...
	for i, field := range fields {
		...
		switch field.Name {
		case "__typename":
			out.Values[i] = graphql.MarshalString("PubM")
		case "login":
			out.Values[i] = ec._PubM_login(ctx, field)
			if out.Values[i] == graphql.Null {
				invalid = true
			}
		case "signup":
			out.Values[i] = ec._PubM_signup(ctx, field)
		default:
			panic("unknown field " + strconv.Quote(field.Name))
		}
	}
...
// nolint: vetshadow
func (ec *executionContext) _PubM_login(ctx context.Context, field graphql.CollectedField) graphql.Marshaler {
	ctx = ec.Tracer.StartFieldExecution(ctx, field)
	defer func() { ec.Tracer.EndFieldExecution(ctx) }()
	...
	resTmp := ec.FieldMiddleware(ctx, nil, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.PubM().Login(rctx, args["username"].(string), args["password"].(string))
	})
	if resTmp == nil {
		if !ec.HasError(rctx) {
			ec.Errorf(ctx, "must not be null")
...
// nolint: vetshadow
func (ec *executionContext) _PubM_signup(ctx context.Context, field graphql.CollectedField) graphql.Marshaler {
	ctx = ec.Tracer.StartFieldExecution(ctx, field)
	defer func() { ec.Tracer.EndFieldExecution(ctx) }()
	rawArgs := field.ArgumentMap(ec.Variables)
	args, err := field_PubM_signup_args(rawArgs)
...
// nolint: gocyclo, errcheck, gas, goconst
func (ec *executionContext) _PubQ(ctx context.Context, sel ast.SelectionSet) graphql.Marshaler {
...
// nolint: vetshadow
func (ec *executionContext) _PubQ_country(ctx context.Context, field graphql.CollectedField) graphql.Marshaler {
	ctx = ec.Tracer.StartFieldExecution(ctx, field)
	defer func() { ec.Tracer.EndFieldExecution(ctx) }()
	rctx := &graphql.ResolverContext{
		Object: "PubQ",
	...
	resTmp := ec.FieldMiddleware(ctx, nil, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.PubQ().Country(rctx)
	})
	if resTmp == nil {
		if !ec.HasError(rctx) {
			ec.Errorf(ctx, "must not be null")
...
// nolint: vetshadow
func (ec *executionContext) _PubQ___type(ctx context.Context, field graphql.CollectedField) graphql.Marshaler {
	ctx = ec.Tracer.StartFieldExecution(ctx, field)
	defer func() { ec.Tracer.EndFieldExecution(ctx) }()
	rawArgs := field.ArgumentMap(ec.Variables)
	args, err := field_PubQ___type_args(rawArgs)
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	}
...
// nolint: vetshadow
func (ec *executionContext) _PubQ___schema(ctx context.Context, field graphql.CollectedField) graphql.Marshaler {
	ctx = ec.Tracer.StartFieldExecution(ctx, field)
	defer func() { ec.Tracer.EndFieldExecution(ctx) }()
	rctx := &graphql.ResolverContext{
		Object: "PubQ",
...
`},
	&ast.Source{Name: "../schemata/pub/schema.gql", Input: `schema {
  query: PubQ
  mutation: PubM
}
`},
